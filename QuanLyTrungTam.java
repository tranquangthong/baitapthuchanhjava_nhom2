...
// Menu dành cho Giáo Viên
    private static void menuGiaoVien(GiaoVien giaoVien, Scanner scanner) {
        ...
        while (true) {
            ...
            System.out.println("7. Tham gia khóa học giảng dạy");  // Thêm lựa chọn tham gia khóa học
            System.out.println("8. Đăng xuất");
            System.out.println("9. Hiển thị danh sách điểm");
            System.out.println("10. Xuất danh sách điểm ra file");
            System.out.print("Nhập lựa chọn của bạn: ");
            int luaChon = scanner.nextInt();
            scanner.nextLine(); // Đọc bỏ dòng trống
            ...
            switch (luaChon) {
                ...
                case 4:
                    ...
                    scanner.nextLine(); // Đọc bỏ dòng trống
                    giaoVien.nhapDiemTheoKhoaHoc(quanLyDiem, tenKhoaHoc, maHocVien, diem);
                    break;
                ...
                case 8:
                    ...
                    return;
                case 9:
                    quanLyDiem.hienThiDanhSachDiem();
                    break;
                case 10:
                    quanLyDiem.xuatDanhSachDiemRaFile();  // Gọi phương thức xuất danh sách điểm ra file
                    break;
                default:
                    System.out.println("Lựa chọn không hợp lệ.");
            }
